...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        """
        state = self.startingState of the actual state = tuple(cornersVisited)
        So to end the game cornersVisited should all be visited so state[1][0] and state[1][1] and state[1][2] and state[1][3] should all be true
        """

        return (cornersVisited[0] and cornersVisited[1] and cornersVisited[2] and cornersVisited[3])
